...
@tool("get_classes_by_course_code", return_direct=True)
...
@tool("get_classes_by_course_name", return_direct=True)
...
@tool("get_class_by_code", return_direct=True)
...
@tool("get_prerequisites_by_course_name", return_direct=True)
...
@tool("get_prerequisites_by_course_code", return_direct=True)
...
@tool("get_class_schedule", return_direct=True)
