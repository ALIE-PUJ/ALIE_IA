...
def ask():
    # Obtener la pregunta y el memory_key del cuerpo de la solicitud
    data = request.json
    question = data.get('question', '')
    memory_key = data.get('memory_key', 'default_memory')

    print("Current memory key: ", memory_key)

    # Crear una memoria de conversación única para cada memory_key
    memory = ConversationBufferMemory(memory_key=memory_key)

    # Inicializar el agente con la memoria correspondiente
