...
def load_documents_from_folders(folders, jq_schema="."):
        ...
        for filename in os.listdir(folder_path):
            if filename.endswith(".json"):
                ...
                for doc in documents:
                    ...
                    doc.metadata = {"source": os.path.basename(folder_path), "doc_id": doc_id}  # Store the folder name as source and generate a unique doc_id
    ...
    docs_splitter = split_documents(all_documents, 512, 64) # Usar multiplos de 2
    ...
    if ids_to_remove:
        for doc_id in ids_to_remove:
            try:
                ...
                del document_id_map[doc_id]  # Remove from the ID map
